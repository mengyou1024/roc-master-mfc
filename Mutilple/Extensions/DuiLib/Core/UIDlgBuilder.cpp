    ...
    for( CMarkupNode node = pRoot->GetChild() ; node.IsValid(); node = node.GetSibling() ) {
		...
		//树控件XML解析
            ...
            case 5:
				...
				else if( _tcscmp(pstrClass, DUI_CTR_COLOR) == 0 )             pControl = new CColorUI;
                break;
            case 6:
            ...
            case 8:
				...
				else if( _tcscmp(pstrClass, DUI_CTR_WINDOW) == 0 )            pControl = new CWindowUI;
                else if (_tcscmp(pstrClass, DUI_CTR_CLICKNUM) == 0)           pControl = new CClickNumUI;
                break;
            case 9:
                ...
                else if (_tcscmp(pstrClass, DUI_CTR_CLICKEDIT) == 0)          pControl = new CClickEditUI;
                break;
            case 10:
