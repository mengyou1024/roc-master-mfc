...
#define DUI_MSGTYPE_CLICK_DOWN             (_T("clickdown"))
#define DUI_MSGTYPE_CLICK_UP               (_T("clickup"))
...
#define DUI_MSGTYPE_MOUSEWHELL				(_T("mousewhell"))
//////////////////////////////////////////////////////////////////////////
...
#define  DUI_CTR_CLICKEDIT                       (_T("ClickEdit"))
#define  DUI_CTR_CLICKNUM                        (_T("ClickNum"))
#define  DUI_CTR_LIST                            (_T("List"))
#define  DUI_CTR_TEXT                            (_T("Text"))
#define  DUI_CTR_COLOR                           (_T("Color"))
...
#define  DUI_CTR_WINDOW							 (_T("WindowUI"))
