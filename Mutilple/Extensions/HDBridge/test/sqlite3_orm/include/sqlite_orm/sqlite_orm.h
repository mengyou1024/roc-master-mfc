...
#if defined(_MSC_VER)
    #pragma warning(disable :4005 4068 4146 4244 4267 4310 4345 4503 4505 4625 4626 4710 4820 4996 4090)
...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        struct primary_key_with_autoincrement {
            ...
            primary_key_with_autoincrement(primary_key_type primary_key_)
        ...
        struct primary_key_t : primary_key_base {
            ...
            primary_key_t(decltype(columns) columns)
        ...
        struct collate_constraint_t {
            ...
            collate_constraint_t(collate_argument argument)
                : argument{argument} {}
#endif
...
#ifndef SQLITE_ORM_AGGREGATE_NSDMI_SUPPORTED
            basic_generated_always(bool full, storage_type storage)
                : full{full}, storage{storage} {}
#endif
        };
...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        struct serializer_context : serializer_context_base {
            ...
            serializer_context(const db_objects_type& dbObjects)
        ...
        struct serializer_context_builder {
            ...
            serializer_context_builder(const storage_type& storage_)
                : storage{storage_} {}
...
namespace sqlite_orm {
    ...
    internal::built_in_function_t<double, internal::atan2_string, X, Y> atan2(X x, Y y) {
        return {
            std::tuple<X, Y>{std::forward<X>(x), std::forward<Y>(y)}
        };
    }
    ...
    internal::built_in_function_t<double, internal::log_string, B, X> log(B b, X x) {
        return {
            std::tuple<B, X>{std::forward<B>(b), std::forward<X>(x)}
        };
    }
    ...
    internal::built_in_function_t<std::string, internal::replace_string, X, Y, Z> replace(X x, Y y, Z z) {
        return {
            std::tuple<X, Y, Z>{std::forward<X>(x), std::forward<Y>(y), std::forward<Z>(z)}
        };
    }
    ...
    max(X x, Y y, Rest... rest) {
        return {
            std::tuple<X, Y, Rest...>{std::forward<X>(x), std::forward<Y>(y), std::forward<Rest>(rest)...}
        };
    }
    ...
    internal::built_in_function_t<R, internal::json_extract_string, X, Args...> json_extract(X x, Args... args) {
        return {
            std::tuple<X, Args...>{std::forward<X>(x), std::forward<Args>(args)...}
        };
    }
...
#ifndef SQLITE_ORM_AGGREGATE_NSDMI_SUPPORTED
            columns_t(columns_type columns)
                : columns{std::move(columns)} {}
#endif
        };
...
#ifndef SQLITE_ORM_AGGREGATE_NSDMI_SUPPORTED
            asterisk_t(bool definedOrder)
                : defined_order{definedOrder} {}
#endif
        };
...
namespace sqlite_orm {
    namespace internal {
        enum class trigger_timing { trigger_before,
                                    trigger_after,
                                    trigger_instead_of };
        enum class trigger_type { trigger_delete,
                                  trigger_insert,
                                  trigger_update };
        ...
        struct trigger_base_t {
            ...
            trigger_base_t(trigger_type_base type_base_)
                : type_base(std::move(type_base_)) {}
        ...
        struct trigger_type_base_t {
            ...
            trigger_type_base_t(trigger_timing timing, trigger_type type)
...
#ifndef SQLITE_ORM_AGGREGATE_NSDMI_SUPPORTED
            raise_t(type_t type, std::string message)
...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        struct conditional_binder {
            ...
            explicit conditional_binder(sqlite3_stmt* stmt)
                : stmt{stmt} {}
        ...
        struct tuple_value_binder {
            ...
            explicit tuple_value_binder(sqlite3_stmt* stmt)
                : stmt{stmt} {}
...
#ifndef SQLITE_ORM_AGGREGATE_NSDMI_SUPPORTED
            index_base(std::string name, bool unique)
                : name{std::move(name)}, unique{unique} {}
#endif
        };
...
#ifndef SQLITE_ORM_AGGREGATE_BASES_SUPPORTED
            lambda_as_template_base(L&& lambda)
                : L{std::move(lambda)} {}
#endif
            template <class... T>
...
#ifndef SQLITE_ORM_AGGREGATE_NSDMI_SUPPORTED
            object_from_column_builder_base(sqlite3_stmt* stmt)
                : stmt{stmt} {}
#endif
        };
...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        public:
            ...
            iterator_t(statement_finalizer stmt_, view_type& view_)
                : stmt{std::move(stmt_)}, view{&view_} {
                next();
            }
    ...
    namespace internal {
        ...
        struct dynamic_set_t {
            ...
            dynamic_set_t(const context_t& context_)
                : context(context_), collector(this->context.db_objects) {}
...
namespace sqlite_orm {
...
#ifndef SQLITE_ORM_AGGREGATE_NSDMI_SUPPORTED
            prepared_statement_base(sqlite3_stmt* stmt, connection_ref con)
                : stmt{stmt}, con{std::move(con)} {}
#endif
...
#ifndef SQLITE_ORM_AGGREGATE_NSDMI_SUPPORTED
            insert_constraint(conflict_action action)
                : action{action} {}
#endif
        };
    ...
    auto replace_range(It from, It to, Projection project = {}) {
        ...
        return internal::replace_range_t<It, Projection, O>{
    ...
    auto insert_range(It from, It to, Projection project = {}) {
        using O = std::decay_t<decltype(polyfill::invoke(std::declval<Projection>(), *std::declval<It>()))>;
        return internal::insert_range_t<It, Projection, O>{
            {std::move(from), std::move(to)},
            std::move(project)
        };
    }
...
namespace sqlite_orm {
    namespace internal {
        ...
        struct exists_t : condition_t, negatable_t {
            ...
            exists_t(expression_type expression_)
                : expression(std::move(expression_)) {}
        };
    } // namespace internal
...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        struct limit_accessor {
            ...
            limit_accessor(get_connection_t get_connection_)
                : get_connection(std::move(get_connection_)) {}
    ...
    namespace internal {
        ...
        public:
            ...
            void create_scalar_function() {
                ...
                constexpr auto argsCount = std::is_same<args_tuple, std::tuple<arg_values>>::value ? -1 : int(std::tuple_size<args_tuple>::value);
