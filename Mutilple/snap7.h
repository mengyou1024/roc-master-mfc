...
// Area ID
const uint8_t S7AreaPE = 0x81;
const uint8_t S7AreaPA = 0x82;
const uint8_t S7AreaMK = 0x83;
const uint8_t S7AreaDB = 0x84;
const uint8_t S7AreaCT = 0x1C;
const uint8_t S7AreaTM = 0x1D;
...
// Block type
const uint8_t Block_OB  = 0x38;
const uint8_t Block_DB  = 0x41;
const uint8_t Block_SDB = 0x42;
const uint8_t Block_FC  = 0x43;
const uint8_t Block_SFC = 0x44;
const uint8_t Block_FB  = 0x45;
const uint8_t Block_SFB = 0x46;

// Sub Block Type
const uint8_t SubBlk_OB  = 0x08;
const uint8_t SubBlk_DB  = 0x0A;
const uint8_t SubBlk_SDB = 0x0B;
const uint8_t SubBlk_FC  = 0x0C;
const uint8_t SubBlk_SFC = 0x0D;
const uint8_t SubBlk_FB  = 0x0E;
const uint8_t SubBlk_SFB = 0x0F;

// Block languages
const uint8_t BlockLangAWL   = 0x01;
const uint8_t BlockLangKOP   = 0x02;
const uint8_t BlockLangFUP   = 0x03;
const uint8_t BlockLangSCL   = 0x04;
const uint8_t BlockLangDB    = 0x05;
const uint8_t BlockLangGRAPH = 0x06;
